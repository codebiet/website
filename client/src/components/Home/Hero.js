          ...
          <div className="row banner-items align-items-center">
            <div className="col-lg-5 col-md-6 pt-md-0 pt-4">
              ...
              <p>
                ...
                flourish the technical skill, competency along with the all
                round development of an individual. CODE aims to establish a
                coding culture on campus, reaching every student passionate
                about development. The club's motto is to Learn-Build-Innovate.
                CODE is for everyone, regardless of their field of study or
