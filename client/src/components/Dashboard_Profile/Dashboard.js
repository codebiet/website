...
const options_ProgrammingLangs = [
  "C/C++",
  "Java",
  "Python",
...
const options_technologies = [
  "VCS(Git/Mercury)",
  "Docker",
  "Kubernates",
  "OpenShift",
  "Gihub/Gitlab/Gitbucket",
];
...
const Dashboard = (props) => {
  ...
  const [callingPhoneInput, callingPhoneNum, setCallingPhoneNum] = useInput({
    type: "text",
    name: "callingPhoneNum",
    id: "dashboard-calling-phone",
    placeholder: "Calling Phone Number",
  });
  const [whatsAppPhoneInput, whatsAppPhoneNum, setWhatsAppPhoneNum] = useInput({
    type: "text",
  ...
  const setDefaultValues = (data) => {
    ...
    setName(data.name);
    setCallingPhoneNum(data.callingPhoneNumber);
    setWhatsAppPhoneNum(data.whatsAppPhoneNumber);
    setYear(data.year);
                                ...
                                <Row style={{ width: "100%" }}>
                                  ...
                                  {/* <Col md="4">
                                    <FormGroup>
                                      ...
                                      <Input
                                        defaultValue="singhsharad529@gmail.com"
                                        placeholder="Email"
                                        type="email"
                                        name="email"
                                        required
                                ...
                                <FormGroup>
                                  ...
                                  >
                                    <input
                                      ...
                                      type="checkbox"
                                      checked={
                                        hostingPlatforms["heroku"].checked ||
                                        false
                                      }
                                      onChange={(e) =>
                                        handleHostingPlatformChange(e, "heroku")
                                      }
                                    />
                                  </div>
                                </FormGroup>
                                ...
                                <FormGroup>
                                  ...
                                  >
                                    <input
                                      ...
                                      onChange={(e) =>
                                        handleHostingPlatformChange(e, "azure")
                                      }
                                    />
                                  </div>
                                </FormGroup>
                                ...
                                <FormGroup>
                                  ...
                                  >
                                    <input
                                      ...
                                      type="checkbox"
                                      checked={
                                        hostingPlatforms["aws"].checked || false
                                      }
                                      onChange={(e) =>
                                        handleHostingPlatformChange(e, "aws")
                                      }
                                    />
                                  </div>
                                </FormGroup>
                                ...
                                <FormGroup>
                                  ...
                                  >
                                    <input
                                      ...
                                      type="checkbox"
                                      checked={
                                        hostingPlatforms["gCloud"].checked ||
                                        false
                                      }
                                      onChange={(e) =>
                                        handleHostingPlatformChange(e, "gCloud")
                                      }
                                    />
                                  </div>
                                </FormGroup>
                                  ...
                                  <Col md="3">
                                    <FormGroup>
                                      <select
                                        ...
                                        onChange={(e) =>
                                          handleInterestChange(e, "preference1")
                                        }
                                      >
                                  ...
                                  <Col md="3">
                                    <FormGroup>
                                      <select
                                        ...
                                        onChange={(e) =>
                                          handleInterestChange(e, "preference2")
                                        }
                                      >
                                  ...
                                  <Col md="3">
                                    <FormGroup>
                                      <select
                                        ...
                                        onChange={(e) =>
                                          handleInterestChange(e, "preference3")
                                        }
                                      >
